...
-- Password: Proveeduria2024!Sys (hash bcrypt generado con: node scripts/generatePasswordHash.js Proveeduria2024!Sys)
...
BEGIN
    ...
    VALUES (
        ...
        '$2b$10$LZ8meIUuJsyZ4a7AxhHYquGwSiHemmerLO8PkAyREdWBlPMo3wuu2', -- Proveeduria2024!Sys
        'Administrador',
        'Administrador',
        1
    );
